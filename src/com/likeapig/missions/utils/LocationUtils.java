...
public class LocationUtils
{
    public static String locationToString(final Location l) {
        ...
        sb.append(String.valueOf(String.valueOf(l.getWorld().getName())) + ":");
        sb.append(String.valueOf(String.valueOf(l.getX())) + ":");
        sb.append(String.valueOf(String.valueOf(l.getY())) + ":");
        sb.append(String.valueOf(String.valueOf(l.getZ())) + ":");
        sb.append(String.valueOf(String.valueOf(l.getPitch())) + ":");
        sb.append(l.getYaw());
        return sb.toString();
    }
    ...
    public static float stringToPitch(final String s) {
        final String[] s2 = s.split(":");
        final World w = Bukkit.getWorld(s2[0]);
        final double x = Double.parseDouble(s2[1]);
        final double y = Double.parseDouble(s2[2]);
    ...
    public static float stringToYaw(final String s) {
        final String[] s2 = s.split(":");
        final World w = Bukkit.getWorld(s2[0]);
        final double x = Double.parseDouble(s2[1]);
        final double y = Double.parseDouble(s2[2]);
